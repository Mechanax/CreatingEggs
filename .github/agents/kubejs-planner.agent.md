...
tools: [vscode/memory, vscode/askQuestions, read, agent, search, prunoideae.probejs/queryRegistryObjectsByRegex, prunoideae.probejs/listRegistries, prunoideae.probejs/queryTagsByRegex, prunoideae.probejs/queryTaggedObjects, prunoideae.probejs/listCommands, todo] # specify the tools this agent can use. If not set, all enabled tools are allowed.
